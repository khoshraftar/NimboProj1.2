...
public class ProcessingData {
    ...
    static int mapUpdate(Map <Long , Integer> devsMap, Map<Long , Integer> repsMap , long x , long y ,
                         int NumOfEvents,ArrayList<String> typeChecker,Map<Long, String> DevsNameMap, Map<Long, String> RepNameMap){
        try {
        ...
        }catch (Exception e){return NumOfEvents;}
        return NumOfEvents;
    }
    static int mapUpdateFromString(Map <Long , Integer> devsMap, Map<Long , Integer> repsMap , long x , long y ,
        ...
        }catch (InputMismatchException e){return NumOfEvents;}
